...
train_prompt_bsz=0
gen_prompt_bsz=1
n_resp_per_prompt=${n_resp_per_prompt:-10}
...
actor_ppo_max_token_len=$(((max_prompt_length + max_response_length) * 10))
infer_ppo_max_token_len=$(((max_prompt_length + max_response_length) * 15))
